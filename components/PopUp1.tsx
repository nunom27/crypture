...
export default function PopUp1({ setPopUpOpened1, popUpOpened1 }: { setPopUpOpened1: any, popUpOpened1: any }) {

  const cancelButtonRef = useRef(null)

  return (
    <Transition.Root show={popUpOpened1} as={Fragment}>
      <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={() => setPopUpOpened1(false)}>
        <Transition.Child
          as={Fragment}
