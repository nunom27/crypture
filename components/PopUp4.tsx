...
export default function PopUp4({ setPopUpOpened4, popUpOpened4 }: { setPopUpOpened4: any, popUpOpened4: any }) {

  const cancelButtonRef = useRef(null)

  return (
    <Transition.Root show={popUpOpened4} as={Fragment}>
      <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={() => setPopUpOpened4(false)}>
        <Transition.Child
          as={Fragment}
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                      ...
                      <div className="mt-3 flex flex-col gap-5 items-start justify-start">
                        <p className="text-sm text-gray-500 text-left">
                          Trade over 100 crypto currencies with USDs.
                        </p>
                        <div className="flex flex-col justify-start items-start">
                          <span className='text-text font-bold'>Choose the amount you want to transfer</span>
                          <input 
                            type="number"
                            // value={transferedCapital}
                            // onChange={e => setTransferedCapital(e.target.value)}
                            min="0"
                            max="10000" 
