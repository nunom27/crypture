...
export default function PopUp3({ setPopUpOpened3, popUpOpened3 }: { setPopUpOpened3: any, popUpOpened3: any }) {

  const cancelButtonRef = useRef(null)

  return (
    <Transition.Root show={popUpOpened3} as={Fragment}>
      <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={() => setPopUpOpened3(false)}>
        <Transition.Child
          as={Fragment}
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                      ...
                      <div className="mt-3 flex flex-col gap-5 items-start justify-start">
                        ...
                        <div className="flex flex-col justify-start items-start">
                          <span className='text-text font-bold'>Choose the amount you want to invest</span>
                          <input 
                            type="number"
